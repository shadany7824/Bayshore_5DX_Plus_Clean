...
export async function sendStamp(body: wm.wm5.protobuf.SaveGameResultRequest)
{
        ...
        for(let i=0; i<1; i++)
        {
            ...
            if(checkCar)
            {
                ...
                let dataStampTarget: any = {
                    carId: body.carId,
                    stampTargetCarId: rgResult.opponentCarId,
                    returnCount: 0,
                    locked: false,
                    recommended: true
                } 
...
export async function shuttleReturnStamp(body: wm.wm5.protobuf.SaveGameResultRequest)
{
    let rgResult = body.rgResult;
        ...
        for(let i=0; i<1; i++)
        {
            ...
            if(checkCar)
            {
                ...
                if(stampTarget)
                {
                    ...
                    console.log(`Updating car ${rgResult.opponentCarId} vs ${body.carId} stamp entry and remove it from your recommendation`);
                ...
                if(stampReturned)
                {
                    console.log(`Stamp returned to ${rgResult.opponentCarId}, recommend it so opponents can fight your ghost`);
